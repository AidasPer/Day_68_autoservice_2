...
urlpatterns = [
    ...
    path('instances/<int:pk>/update', views.OrderUpdateView.as_view(), name='instance_update'),
    path('instances/<int:pk>/delete', views.OrderDeleteView.as_view(), name='instance_delete'),
]
